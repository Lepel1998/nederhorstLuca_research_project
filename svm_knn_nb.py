...
This module contains training of SVM, KNN and NB based on manually extracted features from photos
Based on https://www.youtube.com/watch?v=7sz4WpkUIIs
"""
...
dump(svm_classifier, os.path.join('trained_models', 'InClasSVM_Model.joblib'))
...
dump(knn_classifier, os.path.join('trained_models', 'InClasKNN_Model.joblib'))
...
dump(nb_classifier, os.path.join('trained_models', 'InClasNB_Model.joblib'))
